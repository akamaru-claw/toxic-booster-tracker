...
<!-- Card Edit Modal -->
<div class="mo" id="cMod"><div class="md"><h2><span class="t" id="mN">#1 Jack Dorsey</span></h2><div class="md-sub" id="mS">Twitter-Gründer & Bitcoin-Maxi · Max: 210 · Toxic Booster Genesis</div><div class="md-big" id="mC">0</div><div class="mr"><button class="mb" onclick="aj(-10)">−10</button><button class="mb" onclick="aj(-1)">−1</button><button class="mb" onclick="aj(1)">+1</button><button class="mb" onclick="aj(10)">+10</button></div><div class="mp2"><button onclick="sC(0)">0</button><button onclick="sC(1)">1</button><button onclick="sC(2)">2</button><button onclick="sC(5)">5</button></div><button class="mc2" onclick="clM()">Schließen</button></div></div>
